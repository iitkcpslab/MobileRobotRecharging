...
{
      19,     0,    -1,    20,    -1,     3,    -1,    21,    -1,    13,
      20,    14,    -1,    12,    20,    -1,    20,    10,    20,    -1,
      20,    11,    20,    -1,     9,    20,    -1,    20,     8,    20,
      -1,    20,     7,    20,    -1,    20,     8,    15,     4,    16,
       4,    17,    20,    -1,     5,    -1,     6,    -1
};
...
static const char *const yytname[] =
{
  ...
  "FALSE", "RELEASE", "UNTIL", "NEXT", "AND", "OR", "NOT", "'('", "')'",
...
{
      23,    -8,    -8,    -8,    23,    23,    23,     3,    -3,    -8,
       9,    -8,    30,    -8,    23,    12,    23,    23,    -8,     9,
       2,     9,    -8,    -8,    -7,    10,    -1,    23,    -3
};
...
{
      10,    11,    12,    13,    14,    15,    24,    16,    17,    25,
      19,    21,    22,    23,    26,     1,    27,     2,     3,    16,
      17,     4,     0,    28,     5,     6,     1,    20,     2,     3,
       0,     0,     4,     0,     0,     5,     6,    14,    15,     0,
      16,    17,     0,     0,    18
};
...
{
       4,     5,     6,     0,     7,     8,     4,    10,    11,    16,
      14,    15,    16,    17,     4,     3,    17,     5,     6,    10,
      11,     9,    -1,    27,    12,    13,     3,    15,     5,     6,
      -1,    -1,     9,    -1,    -1,    12,    13,     7,     8,    -1,
      10,    11,    -1,    -1,    14
};
...
{
       0,     3,     5,     6,     9,    12,    13,    19,    20,    21,
      20,    20,    20,     0,     7,     8,    10,    11,    14,    20,
      15,    20,    20,    20,     4,    16,     4,    17,    20
};
...
/* Line 1806 of yacc.c  */
#line 75 "generateconstraints.y"
    {
            sprintf((yyval.s), "%s", (yyvsp[(2) - (3)].s));
          }
    break;
...
/* Line 1806 of yacc.c  */
#line 79 "generateconstraints.y"
    {
            sprintf(str, "not %s", (yyvsp[(2) - (2)].s));
            ...
            {
              if (strcmp((yyvsp[(2) - (2)].s), "true") == 0)
                strcpy(str1, "false");
              else if (strcmp((yyvsp[(2) - (2)].s), "false") == 0)
                strcpy(str1, "true");
              else
                sprintf(str1, "(= %s_%d false)", (yyvsp[(2) - (2)].s), loop_count);
...
/* Line 1806 of yacc.c  */
#line 107 "generateconstraints.y"
    {
            sprintf(str, "%s /\\ %s", (yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s));
            if (findProposition(str) == NULL)
            {
              sprintf((yyval.s), "p_%d", variable_count);
              declareVariable(ofp2, str, (yyval.s));
            ...
            for (loop_count = 1; loop_count <= length + 1; loop_count++)
            {
              if (strcmp((yyvsp[(1) - (3)].s), "true") == 0)
                strcpy(str1, "true");
              else if (strcmp((yyvsp[(1) - (3)].s), "false") == 0)
                strcpy(str1, "false");
              else
	        sprintf(str1, "%s_%d", (yyvsp[(1) - (3)].s), loop_count);
              if (strcmp((yyvsp[(3) - (3)].s), "true") == 0)
                strcpy(str2, "true");
              else if (strcmp((yyvsp[(3) - (3)].s), "false") == 0)
                strcpy(str2, "false");
              else
	        sprintf(str2, "%s_%d", (yyvsp[(3) - (3)].s), loop_count);
...
/* Line 1806 of yacc.c  */
#line 141 "generateconstraints.y"
    {
            sprintf(str, "%s \\/ %s", (yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s));
	    if (findProposition(str) == NULL)
            {
...
/* Line 1806 of yacc.c  */
#line 175 "generateconstraints.y"
    {
            sprintf(str, "X %s", (yyvsp[(2) - (2)].s));
            if (findProposition(str) == NULL)
            {
              sprintf((yyval.s), "p_%d", variable_count);
              declareVariable(ofp2, str, (yyval.s));
            ...
            {
              fprintf(ofp1, "(assert (=> %s_%d %s_%d))\n", (yyval.s), loop_count, (yyvsp[(2) - (2)].s), loop_count + 1);
              fprintf(ofp1, "(assert (=> %s_%d %s_%d))\n", (yyvsp[(2) - (2)].s), loop_count + 1, (yyval.s), loop_count);
            }
            fprintf(ofp1, "\n");
          }
    break;
...
/* Line 1806 of yacc.c  */
#line 197 "generateconstraints.y"
    {
            sprintf(str, "%s U %s", (yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s));
            if (findProposition(str) == NULL)
            {
              sprintf((yyval.s), "p_%d", variable_count);
              declareVariable(ofp2, str, (yyval.s));
            ...
            {
              fprintf(ofp1, "(assert (=> f_%d_%d (or f_%d_%d (and inloop_%d %s_%d))))\n", until_count, loop_count, until_count, loop_count - 1, loop_count, (yyvsp[(3) - (3)].s), loop_count);
              fprintf(ofp1, "(assert (=> (or f_%d_%d (and inloop_%d %s_%d)) f_%d_%d))\n", until_count, loop_count - 1, loop_count, (yyvsp[(3) - (3)].s), loop_count, until_count, loop_count);
            }  
            fprintf(ofp1, "\n");
...
/* Line 1806 of yacc.c  */
#line 244 "generateconstraints.y"
    {
            sprintf(str, "%s R %s", (yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s));
            if (findProposition(str) == NULL)
            {
              sprintf((yyval.s), "p_%d", variable_count);
              declareVariable(ofp2, str, (yyval.s));
...
/* Line 1806 of yacc.c  */
#line 294 "generateconstraints.y"
    {
            lower_limit = atoi((yyvsp[(4) - (8)].s));
	    upper_limit = atoi((yyvsp[(6) - (8)].s));
            
            sprintf(str, "%s U[%s,%s] %s", (yyvsp[(1) - (8)].s), (yyvsp[(4) - (8)].s), (yyvsp[(6) - (8)].s), (yyvsp[(8) - (8)].s));
            if (findProposition(str) == NULL)
            {
              sprintf((yyval.s), "p_%d", variable_count);
              declareVariable(ofp2, str, (yyval.s));
	    ...
	    for (loop_count = 1; loop_count <= (upper_limit - lower_limit + 1); loop_count++)
            {
              sprintf(str1, "%s U[%d,%d] %s", (yyvsp[(1) - (8)].s), loop_count, (upper_limit - lower_limit + 1), (yyvsp[(8) - (8)].s));
	      ...
	      fprintf(ofp1, "(assert (=> %s_%d", (yyval.s), loop_count);
              ...
              {
                if (strcmp((yyvsp[(1) - (8)].s), "true") == 0)
                  strcpy(str1, "true");
                else if (strcmp((yyvsp[(1) - (8)].s), "false") == 0)
                  strcpy(str1, "false");
                else
                    sprintf(str1, "%s_%d", (yyvsp[(1) - (8)].s), count1);
                fprintf(ofp1, " %s", str1);
              }
	    ...
	    for(loop_count = lower_limit + 1; loop_count <= length - 1; loop_count++)
            {
              for (count1 = 2 ; count1 <= (upper_limit - lower_limit + 1) ; count1++)
              {
                if (strcmp((yyvsp[(1) - (8)].s), "true") == 0)
                  ...
                  sprintf(str1, "%s_%d", (yyvsp[(1) - (8)].s), loop_count);

                if (strcmp((yyvsp[(8) - (8)].s), "true") == 0)
                  strcpy(str2, "true");
                else if (strcmp((yyvsp[(8) - (8)].s), "false") == 0)
                  strcpy(str2, "false");
                else
                  sprintf(str2, "%s_%d", (yyvsp[(8) - (8)].s), loop_count);
	      ...
	      if (strcmp((yyvsp[(8) - (8)].s), "true") == 0)
            ...
            if (strcmp((yyvsp[(8) - (8)].s), "true") == 0)
              ...
              sprintf(str2, "%s_%d", (yyvsp[(8) - (8)].s), length);
...
/* Line 1806 of yacc.c  */
#line 545 "generateconstraints.y"
    {
            strcpy((yyval.s), "true");
          }
    break;
...
/* Line 1806 of yacc.c  */
#line 549 "generateconstraints.y"
    {
...
/* Line 2067 of yacc.c  */
#line 554 "generateconstraints.y"
